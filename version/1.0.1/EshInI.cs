...
namespace Eshiba
{
    public class IniFile
    {
        ...
        /// <summary>
        /// Записываем в ini-файл, ставит ковычки вокруг значения. Запись происходит в выбранную секцию в выбранный ключ.
        /// </summary>
        /// <param name="Section"></param>
        /// <param name="Key"></param>
        /// <param name="Value"></param>
        public void Write_Quotes(string Section, string Key, string Value)
        {
            WritePrivateProfileString(Section, Key, '"' + Value + '"', Path);
        }
